...
val layers = Array[Int](53, 50, 40, 30, 20, 10, 5, 2)
...
val pipeline = new Pipeline().
    setStages(Array(jobIndexer, maritalIndexer, educationIndexer, defaultIndexer, housingIndexer, loanIndexer, contactIndexer, monthIndexer, dayOfWeekIndexer, pOutcomeIndexer, encoder, assembler, labelIndexer, mp, labelConverter))

val mpModel = pipeline.fit(trainingData)

val predictions = mpModel.transform(testData)
