...
val pipeline = new Pipeline().
    setStages(Array(jobIndexer, maritalIndexer, educationIndexer, defaultIndexer, housingIndexer, loanIndexer, contactIndexer, monthIndexer, dayOfWeekIndexer, pOutcomeIndexer, encoder, assembler, labelIndexer, lsvc, labelConverter))

val lsvcModel = pipeline.fit(trainingData)
